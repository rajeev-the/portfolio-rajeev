...
import video5 from "../assets/img3.mp4"
...
<button className='' onClick={handleChange2}  ><img src="data:image/png;base64,"/></button>
   { second ? <div className=' h-[85%] bg-white  w-[70%]   rounded-[50px]  flex items-center justify-center text-black text-xl '>
     <video autoPlay muted className='rounded-[50px] w-[100%] h-[100%] bg-black' src={video5}></video>
   </div>   : <div className=' h-[85%] bg-white  w-[70%]  flex items-center justify-center text-black text-xl  rounded-[50px]'>
     <video autoPlay muted className='rounded-[50px] w-[100%] h-[100%] bg-black' src={video5}></video>  </div>  }  
